...
@app.get("/")
async def form():
    index_html_path = os.path.join('D:/PytorchProjects/resnetpotatoclf/frontend/index.html')
...
async def predict(file: UploadFile = File(...)):
    ...
    <p>Confidence Level: {confndence}</p>
    """
    ...
    # Insert the prediction result into the HTML template
    content = content.replace("</form>", result_html + "</form>")
    return HTMLResponse(content=content)
